        ...
        <div className="mt-12 lg:mt-16 grid lg:grid-cols-2 gap-8 lg:gap-12">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div className="sm:col-span-1">
                    ...
                    >
                      ...
                      <option value="dispute">{t("types.dispute")}</option>
                    </select>
                  </div>
          ...
          >
            ...
            >
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <div>
                    <div className="text-slate-200/55 text-sm">
                      {t("direct.phoneLabel")}
                    </div>
                    <div className="text-white font-semibold">
                      +972 50 123 4567
            ...
            >
              ...
              <ul className="space-y-3">
                {(t.raw("why.items") as unknown as string[]).map(
                  (item: string) => (
                    <li
                      key={item}
                      className={[
            ...
            >
              ...
              <div className="mt-4 pt-4 border-t border-white/10">
                <p className="text-slate-200/55 text-sm">{t("office.hours")}</p>
              </div>
            </motion.div>
          </motion.div>
        </div>

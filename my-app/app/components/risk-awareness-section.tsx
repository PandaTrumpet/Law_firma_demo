...
export function RiskAwarenessSection() {
  ...
  const risks = [
    {
      icon: AlertTriangle,
      title: t("cards.liabilities.title"),
      description: t("cards.liabilities.description"),
      impact: t("cards.liabilities.impact"),
    },
    {
      icon: FileWarning,
      title: t("cards.contract.title"),
      description: t("cards.contract.description"),
      impact: t("cards.contract.impact"),
    },
    {
      icon: Lock,
      title: t("cards.debts.title"),
      description: t("cards.debts.description"),
      impact: t("cards.debts.impact"),
    },
  ];
  ...
  return (
    <section
      ...
      className="relative overflow-hidden text-white"
    >
      {/* Background: unified corporate system */}
      <div className="absolute inset-0 -z-10 bg-[#0F1E30]" />
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-gradient-to-b from-white/[0.03] via-transparent to-black/10" />
